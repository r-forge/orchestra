...
public class LtySideKickCompletion extends SideKickCompletion {

	public LtySideKickCompletion(View view, String text, Object[] items) {
		super(view, text, items);
	}

	@Override
	public ListCellRenderer getRenderer() {
		return new LtyListCellRenderer();
	}
