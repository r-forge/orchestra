...
public class PchSideKickCompletion extends SideKickCompletion {

	public PchSideKickCompletion(View view, String text, Object[] items) {
		super(view, text, items);
	}

	@Override
	public ListCellRenderer getRenderer() {
		return new PchListCellRenderer();
	}
