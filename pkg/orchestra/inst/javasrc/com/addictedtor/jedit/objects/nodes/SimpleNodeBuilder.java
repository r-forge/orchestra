...
/**
 * A simple node builder. it builds the node for simple REXP objects
 * and potentially child nodes for its attributes. 
 * 
 * @author Romain Francois <francoisromain@free.fr>
 *
 */
public class SimpleNodeBuilder extends NodeBuilder {
